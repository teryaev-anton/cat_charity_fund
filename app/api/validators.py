...
async def check_name_duplicate(
    ...
    """
    Проверка проекта на уникальность имени.
    Ничего не возвращает, если проверка пройдена.
    """
...
async def check_charity_project_before_edit(
    ...
    """
    Проверка проекта при обновлении и удалении.
    Возвращает проект, если не было перехвачено исключений.
    """
